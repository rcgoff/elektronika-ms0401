...
; 006Bh  _EOF   EOF position
; 0085h         command letter
...
;*******************************
;Table conversion
;on call, C contains value to convert
;on return, C contains converted value
;           Acc contains: in bit 1 - CY before call
